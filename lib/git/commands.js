...
var github_app_auth = require('./github_app_auth.js');
...
var run_command = function(cmd, cwd, cb) {
  ...
  var child = exec(cmd, {cwd: cwd, maxBuffer: 1024 * 500}, function(err, stdout, stderr) {
...
exports.clone = function(repo_url, branch_name, cwd, cb) {
  github_app_auth.refreshIfNeeded(function(err) {
